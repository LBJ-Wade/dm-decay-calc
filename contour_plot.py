...
fid = "chi2file-"+obs+'-'+str(n_omega_dm)+'-'+str(n_omega_lambda)+\
        '-'+str(n_tau)+'.bin'
...
plt.figure()
contourOmTau = plt.contour(logtau_array, omega_dm_array, dchi2_omtau, 
        levels=[2.3, 5.0])
